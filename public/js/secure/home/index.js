...
/***/ "./node_modules/bootstrap-table/dist/extensions/auto-refresh/bootstrap-table-auto-refresh.min.js":
/*!*******************************************************************************************************!*\
  !*** ./node_modules/bootstrap-table/dist/extensions/auto-refresh/bootstrap-table-auto-refresh.min.js ***!
  \*******************************************************************************************************/
...
(() => {
/*!*******************************************!*\
  !*** ./resources/js/secure/home/index.js ***!
  \*******************************************/
__webpack_require__(/*! bootstrap-table */ "./node_modules/bootstrap-table/dist/bootstrap-table.min.js");

__webpack_require__(/*! bootstrap-table/dist/extensions/auto-refresh/bootstrap-table-auto-refresh.min */ "./node_modules/bootstrap-table/dist/extensions/auto-refresh/bootstrap-table-auto-refresh.min.js");

var Swal = __webpack_require__(/*! sweetalert2 */ "./node_modules/sweetalert2/dist/sweetalert2.all.js");

var editDeviceUrl = document.querySelector('meta[name="edit-device-url"]').getAttribute('content');
var deleteDeviceUrl = document.querySelector('meta[name="delete-device-url"]').getAttribute('content');

window.actionFormatter = function (value, row) {
  var url = editDeviceUrl.replace(':id', value);
  var actions = [];
  actions.push("<a href='".concat(url, "' class='btn btn-primary'><i class=\"far fa-eye\"></i></a>"));
  actions.push('&nbsp;');
  actions.push("<a href='#' onclick=\"del(".concat(value, ")\" class='btn btn-danger'><i class=\"fas fa-trash\"></i></a>"));
  return actions.join('');
};
...
window.del = function (id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      axios.post(deleteDeviceUrl.replace(':id', id)).then(function (response) {
